...
- #### Configure the upstream
  ...
  Now that you have the local copy of compareX. There is more than one developer contributing to the project, so you have to update your local copy very frequently. Therefore, you need to connect your local copy to the original repository. To do that :
